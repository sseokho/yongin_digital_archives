...
!function(t, e) {
    ...
    )), N = W("native-function-to-string", Function.toString), I = a.WeakMap, B = "function" == typeof I && /native code/.test(N.call(I)), D = 0, P = Math.random(), F = function(t) {
    ...
    var K = {
      ...
      , Nt = function(t, e) {
        var r;
        return Rt(t) && ("function" != typeof (r = t.constructor) || r !== Array && !Rt(r.prototype) ? x(r) && null === (r = r[Wt]) && (r = void 0) : r = void 0),
        ...
        (t.exports = function(t, r, i, n, o) {
            ...
            if (o)
                ...
                if ("function" != typeof (a = function(t) {
                    if (null != t)
                        return t[nr] || t["@@iterator"] || le[We(t)]
                }(t)))
    ...
    function Pi(t, e) {
        ...
        return r.cache = new (Pi.Cache || Wi),
        r
    }
    function Fi(t) {
        var e = typeof t;
